  ...
  return (
    ...
    <Container>
      ...
      <LinkContainer>
        ...
        <LinkItem><ConfirmButton onClick={() => navigate('')} text="추천 식단 즐겨찾기" textAlign="left" paddingLeft="25px" color="#000000" backgroundColor="#E6E6FA" /></LinkItem> // 이동주소로 변경필요
        <LinkItem><ConfirmButton onClick={() => navigate('')} text="포도 쓰러 가기" textAlign="left" paddingLeft="25px" color="#000000" backgroundColor="#E6E6FA" /></LinkItem> // 이동주소로 변경필요
